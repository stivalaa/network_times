#!/usr/bin/env python
#
# File:    lastTransitiveClosureTime.py
# Author:  Alex Stivala
# Created: May 2020
#
...
#
# This version (as opposed to the original transitiveClosureTime.py
...
#
# Usage: lastTransitiveClosureTime.py [-v] < input.csv > output.txt
#
...
# transitive closure processed, with opening time (timestamp from input)
...
def run_example():
    ...
    close_times = lastTransitiveClosureTime(numNodes, example_trans, verbose=True)
...
def main():
    ...
    sys.stdout.write('open_timestamp transitive_close_delta_time\n')
    time_tuples = lastTransitiveClosureTime(numNodes, transactions, verbose)
